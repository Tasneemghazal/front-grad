...
export default function MainPage_4() {
  ...
  <Grid container spacing={2} sx={{mt:3}}>
    <Grid item xs={12} md={3}>
      <Paper sx={{ padding: 3 ,'&:hover':{backgroundColor:'#e0e0e0', transition:'0.5s',scale:'1.1'}}} >
      ...
      <Paper sx={{ padding: 3, marginTop: 2,'&:hover':{backgroundColor:'#e0e0e0', transition:'0.5s',scale:'1.1'} }}>
    ...
    <Grid item xs={6} md={6} sx={{ margin: { xs: "auto", md: 0 }, width: "60%", display: { xs: "none", md: "flex" },flexDirection:{md:"column"}, justifyContent:{md:"center"} }}>
      <Paper sx={{ margin: "auto", padding: 3,width:"60%",'&:hover':{backgroundColor:'#e0e0e0', transition:'0.5s',scale:'1.1'} }}>
